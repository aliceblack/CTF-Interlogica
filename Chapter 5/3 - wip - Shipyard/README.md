...
The contact form can edit the js file in the server, edit the js file where it contains "thisBreaksTheApllicationSecurity"...
...
Thenyou find some code that says
this.link = atob("L2NsaWVudC9zaGlweWFyZC1jbGllbnQtYXBwbGljYXRpb24uamFy")
which means '/client/shipyard-client-application.jar', if you visit that it dowloads a jar that you can execute or edit:  
![jar.JPG](jar.JPG) 

If you edit the license check you can do things.